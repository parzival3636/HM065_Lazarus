...
import FigmaReview from './components/FigmaReview'
import DeveloperFigmaSubmissions from './components/DeveloperFigmaSubmissions'
import CompanyFigmaSubmissions from './components/CompanyFigmaSubmissions'
import './App.css'
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/dashboard/company/figma-submissions" element={<CompanyFigmaSubmissions />} />
        <Route path="/dashboard/company/figma-review/:projectId" element={<FigmaReview />} />
        ...
        <Route path="/dashboard/developer/figma-submissions" element={<DeveloperFigmaSubmissions />} />
