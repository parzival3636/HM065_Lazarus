              ...
              <div className="stats-grid">
                {userType === 'developer' ? (
                  <>
                    ...
                    <div className="stat-card">
                      <h3>₹{mockDeveloperData.totalEarnings.toLocaleString('en-IN')}</h3>
                      <p>Total Earnings</p>
                    </div>
                    <div className="stat-card">
                  ...
                  <>
                    ...
                    <div className="stat-card">
                      <h3>₹{mockCompanyData.totalSpent.toLocaleString('en-IN')}</h3>
                      <p>Total Spent</p>
                    </div>
                    <div className="stat-card">
                      <h3>₹{mockCompanyData.averageProjectBudget.toLocaleString('en-IN')}</h3>
                      <p>Avg Project Budget</p>
                    </div>
                    <div className="stat-card">
                      <h3>₹{mockCompanyData.walletBalance.toLocaleString('en-IN')}</h3>
                      <p>Wallet Balance</p>
                    </div>
                  </>
                )}
              ...
              <div className="wallet-overview">
                <div className="wallet-card">
                  ...
                  <div className="balance-amount">
                    ₹{(userType === 'developer' ? mockDeveloperData.walletBalance : mockCompanyData.walletBalance).toLocaleString('en-IN')}
                  </div>
                ...
                {userType === 'developer' && (
                  <div className="wallet-card">
                    ...
                    <div className="balance-amount pending">
                      ₹{mockDeveloperData.pendingAmount.toLocaleString('en-IN')}
                    </div>
