...
urlpatterns = [
    ...
    path('team-suggestions/', views.get_team_suggestions, name='get_team_suggestions'),
    path('teams/create/', views.create_company_team, name='create_company_team'),
    path('teams/', views.get_teams, name='get_teams'),
    path('teams/add-member/', views.add_to_team, name='add_to_team'),
