...
class TeamFormation(models.Model):
    """Smart team formation suggestions for projects."""
    project_id = models.CharField(max_length=100)  # Supabase project ID
    suggested_team = models.JSONField()  # Array of developer IDs with roles
    team_score = models.DecimalField(max_digits=5, decimal_places=2)  # Compatibility score
    skills_coverage = models.JSONField()  # Skills covered by team
